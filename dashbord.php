    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
            ...
            <li><a class="nav-link scrollto login-btn" href="logout.php">logout</a></li>
        </ul>
...
<div class="col-lg-4 col-md-6 produit-item filter-Add-to-Cart wow fadeInUp">
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/rose.jfif" class="img-fluid" alt="Roses Rouge">
      <a href="assets/img/rose.jfif" data-gallery="produitGallery" class="link-preview produit-lightbox" title="Preview"><i class="bx bx-plus"></i></a>
    </figure>

    <!-- Replace 1 with the appropriate flower ID -->
    <div style="padding: 3px;">
      <center><a href="page-commande.php?flower_id=1&flower_name=roses%20rouge" class="add-to-cart-button">Add to Cart</a></center>
    </div>

    <!-- Insert the name of the flower and its price here -->
    <center>
      <p id="roses_rouge">Roses Rouge</p>
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/rose2.jfif" class="img-fluid" alt="Roses Rouge">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/rose3.jpg" class="img-fluid" alt="Roses Rouge">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/mari1.jfif" class="img-fluid" alt="boquet de fleur de mariage">
    ...
    <!-- Replace 1 with the appropriate flower ID -->
    <div style="padding: 3px;">
      <center><a href="page-commande.php?flower_id=1&flower_name=boquet%20mariage" class="add-to-cart-button">Add to Cart</a></center>
    </div>

    <!-- Insert the name of the flower and its price here -->
    <center>
      <p id="boquet_mariage">boquet de fleur de mariage</p>
      <p class="price">Price: $50</p>
    </center>
  </div>
</div>
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/mari2.jfif" class="img-fluid" alt="boquet de fleur de mariage">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/mari3.jfif" class="img-fluid" alt="boquet de fleur de mariage">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/boqu1.jfif" class="img-fluid" alt="boquet de fleurs">
    ...
    <!-- Replace 1 with the appropriate flower ID -->
    <div style="padding: 3px;">
      <center><a href="page-commande.php?flower_id=1&flower_name=boquet%20fleurs" class="add-to-cart-button">Add to Cart</a></center>
    </div>

    <!-- Insert the name of the flower and its price here -->
    <center>
      <p id="boquet_fleur">boquet de fleurs</p>
      <p class="price">Price: $50</p>
    </center>
  </div>
</div>
 ...
 <div class="col-lg-4 col-md-6 produit-item filter-Add-to-Cart wow fadeInUp">
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/boqu2.jfif" class="img-fluid" alt="boquet de fleurs">
 ...
 <div class="col-lg-4 col-md-6 produit-item filter-Add-to-Cart wow fadeInUp">
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/boqu3.jfif" class="img-fluid" alt="boquet de fleurs">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/flower1.jfif" class="img-fluid" alt="flowerbox">
    ...
    <!-- Replace 1 with the appropriate flower ID -->
    <div style="padding: 3px;">
      <center><a href="page-commande.php?flower_id=1&flower_name=flower%20box" class="add-to-cart-button">Add to Cart</a></center>
    </div>

    <!-- Insert the name of the flower and its price here -->
    <center>
      <p id="flower_box">flower box</p>
      <p class="price">Price: 40 DT</p>
    </center>
  </div>
</div>
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/flower2.jfif" class="img-fluid" alt="flowerbox">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/flower3.jfif" class="img-fluid" alt="flowerbox">
  ...
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/gift1.jfif" class="img-fluid" alt="gift box">
    ...
    <!-- Replace 1 with the appropriate flower ID -->
    <div style="padding: 3px;">
      <center><a href="page-commande.php?flower_id=1&flower_name=gift%20box" class="add-to-cart-button">Add to Cart</a></center>
    </div>

    <!-- Insert the name of the flower and its price here -->
    <center>
      <p id="gift_box">gift box</p>
      <p class="price">Price: $50</p>
    </center>
  </div>
</div>
 ...
 <div class="col-lg-4 col-md-6 produit-item filter-Add-to-Cart wow fadeInUp">
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/gift2.jpg" class="img-fluid" alt="gift box">
 ...
 <div class="col-lg-4 col-md-6 produit-item filter-Add-to-Cart wow fadeInUp">
  <div class="produit-wrap card">
    <figure>
      <img src="assets/img/gift4.jfif" class="img-fluid" alt="gift box">
      <a href="assets/img/gift4.jfif" data-gallery="produitGallery" class="link-preview produit-lightbox" title="Preview"><i class="bx bx-plus"></i></a>
    </figure>
